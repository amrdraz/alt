  ...
  actions: {
    ...
    itemAdd: function(interaction, type) {
      ...
      item = this.store.createRecord(type, {
        name: ((type==="item")?"شيء":"هدف")+" "+(items.get('length')+1),
...
var Interaction = DS.Model.extend({
  ...
  type: DS.attr('string',{defaultValue: 'أكمل'}), //based on type
  types: ['سحب', 'أكمل', 'إختيار'],
  isDrag: function(){
    return (this.get('type')==='سحب');
  }.property('type'),
  isContinue: function(){
    return (this.get('type')==='أكمل');
  }.property('type'),
   isChoose: function(){
    return (this.get('type')==='إختيار');
  }.property('type'),
...
function program3(depth0,data) {
  ...
  data.buffer.push("\n<div class=\"main-container\" dir=\"rtl\">\n\n<header class=\"navbar navbar-static-top bs-docs-nav main-header\" id=\"top\" role=\"banner\">\n  <div class=\"container\">\n    <div class=\"navbar-header\">\n      <button class=\"navbar-toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\".bs-navbar-collapse\">\n        <span class=\"sr-only\">Toggle navigation</span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n      </button>\n      \n        <a href=\"../\" class=\"navbar-brand logo\">عبقر</a>\n      \n    </div>\n    <nav class=\"collapse navbar-collapse bs-navbar-collapse\" role=\"navigation\">\n      \n      <ul class=\"nav navbar-nav navbar-left\">\n        ");
  ...
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n        <li>\n          <a id=\"feedbackForm\" href=\"https://docs.google.com/forms/d/18k6eL5UrSM5jSffST--mYU7k5LQZ-lv_QNf9lrXGWpE/viewform\" class=\"btn\">رأيك</a>\n        </li>\n      </ul>\n    </nav>\n  </div>\n</header>\n  <main class=\"container-fluid\">\n  ");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "outlet", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("  \n  </main>\n  \n  \n  <footer class=\"footer\" >\n    <p>حقوق ملكية © عبقر 2014</p>\n  </footer>\n  </div>");
  return buffer;
...
function program1(depth0,data) {
  ...
  data.buffer.push(" class=\"btn btn-danger\">إلغاء</button>\n      </div>\n    </div>\n  </div>\n  ");
  return buffer;
  }
function program2(depth0,data) {
  
  
  data.buffer.push("عرض");
  }

function program4(depth0,data) {
  
  
  data.buffer.push("تعديل");
  }
...
function program1(depth0,data) {
  ...
  data.buffer.push(" class=\"btn btn-default pull-left\">\n    ");
  hashTypes = {};
  hashContexts = {};
...
function program7(depth0,data) {
  ...
  data.buffer.push(" class=\"btn btn-info btn-sm pull-left\">أضف شيء</button>\n      <h3 class=\"panel-title\">أشياء</h3>\n      </div>\n      <ul class=\"list-group\">\n      ");
  hashTypes = {};
  hashContexts = {};
  ...
  data.buffer.push(" class=\"btn btn-default btn-sm pull-left\">أضف هدف</button>\n      <h3 class=\"panel-title\">أهداف</h3>\n      </div>\n      <ul class=\"list-group\">\n      ");
  hashTypes = {};
  hashContexts = {};
...
function program8(depth0,data) {
  ...
  data.buffer.push("  type=\"button\" title=\"Delete\" class=\"btn btn-info pull-left\" aria-hidden=\"true\">الغي &times;</button>\n           \n        </li>\n      ");
  return buffer;
  }
...
function program10(depth0,data) {
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers['bind-attr'] || depth0['bind-attr']),stack1 ? stack1.call(depth0, options) : helperMissing.call(depth0, "bind-attr", options))));
  data.buffer.push("  class=\"img-responsive small-image\"></a>\n          <label class=\"media-heading\">إسم الهدف: ");
  hashContexts = {'value': depth0};
  hashTypes = {'value': "ID"};
  options = {hash:{
    'value': ("target.name")
...
function program12(depth0,data) {
  ...
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "itemAdd", "model", "target", {hash:{},contexts:[depth0,depth0,depth0],types:["STRING","ID","STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push(" class=\"btn btn-default btn-sm pull-left\">أضف إختيار</button>\n      <h3 class=\"panel-title\">إختيارات</h3>\n      </div>\n      <ul class=\"list-group\">\n      ");
  hashTypes = {};
  hashContexts = {};
...
function program13(depth0,data) {
  ...
  data.buffer.push("\n           </div>\n          <label class=\"media-heading\">إختيار: ");
  hashContexts = {'value': depth0};
  hashTypes = {'value': "ID"};
  options = {hash:{
    'value': ("target.name")
...
function program32(depth0,data) {
  ...
  data.buffer.push(" class=\"btn btn-block btn-lg btn-primary\">كمل ل ");
  hashTypes = {};
  hashContexts = {};
...
function program15(depth0,data) {
  ...
  data.buffer.push(" type=\"button\" class=\"btn btn-danger pull-left\" aria-hidden=\"true\">إمسح الكلام</button>\n");
  return buffer;
  }
...
function program24(depth0,data) {
  ...
  data.buffer.push(" type=\"button\" class=\"btn btn-danger pull-right\" aria-hidden=\"true\">الغي &times;</button>\n    ");
  return buffer;
  }
...
function program26(depth0,data) {
  ...
  data.buffer.push(" class=\"btn btn-default pull-right\">أضف <i class=\"glyphicon glyphicon-plus\"></i>\n        </a>\n    ");
  return buffer;
  }
...
function program16(depth0,data) {
  ...
  hashTypes = {'class': "STRING"};
  options = {hash:{
    'class': ("btn glyphicon glyphicon-log-out")
  },inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["STRING"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  stack2 = ((stack1 = helpers['link-to'] || depth0['link-to']),stack1 ? stack1.call(depth0, "dashboard", options) : helperMissing.call(depth0, "link-to", "dashboard", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n");
...
function program3(depth0,data) {
  ...
  data.buffer.push(" class=\"btn btn-block btn-lg btn-primary\" >إبدأ</button>\n        \n");
  return buffer;
...
var ApplicationView = Ember.View.extend({
  didInsertElement: function () {
    ...
    $('#feedbackForm').click(function () {
      ...
      window.location.href = "https://docs.google.com/forms/d/18k6eL5UrSM5jSffST--mYU7k5LQZ-lv_QNf9lrXGWpE/viewform";
    });

    function loadExample() {
        localStorage['DS.LSAdapter'] = '{"App.Lesson":{"records":{"am78g":{"id":"am78g","title":"نموذج درس","color":"rgb(160,199,113)","description":"<p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\"><br></font></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">ده&nbsp;شرح للدرس،&nbsp;تقدر&nbsp;تعدل الدرس بالضغط على زر \\"عدل\\"&nbsp;بجانب إسم الدرس.</font></p><p style=\\"text-align: center;\\"><br></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">بعد الضغط علي \\"عدل\\"،&nbsp;تقدر تغير الكلمات دي&nbsp;عن طريق الضغط مرتين على الكلمات&nbsp;هنا، ولوقف تغيير الشرح إضغط مرتين&nbsp;على عرض الشرح الموجود&nbsp;تحت.</font></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\"><br></font></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">وتقدر تغير إسم الدرس عن طريق&nbsp;الضغط مرتين على الإسم.</font></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\"><br></font></p><p style=\\"text-align: center;\\"></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">لو الدرس بقى شكله مش لطيف وعايز ترجّع كل حاجة زي ما كانت، إضغط على \\"لوحة دروسي\\"<span id=\\"sceditor-end-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span><span id=\\"sceditor-start-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span>&nbsp;وإضغط على \\"مسح\\" وإعمل إعادة تحميل للصفحة.</font></p><p style=\\"text-align: center;\\"><br></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">إضغط على \\"إبدأ\\" للإستكمال.</font></p><p style=\\"text-align: center; direction: rtl;\\"><br></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\"></font></p><p style=\\"text-align: center;\\"><br></p>","date":null,"scenes":["rrgc8","kq8c1","9aq44","d2ing","fpcnf"],"ueer":null}}},"App.Scene":{"records":{"rrgc8":{"id":"rrgc8","name":"الجزء ١","content":"<p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">ده الجزء الأول، كل درس يتكون من أجزاء يتفاعل معها الدارس.</font></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\"><br></font></p><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">إضغط على الزر تحت.<span id=\\"sceditor-end-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span><span id=\\"sceditor-start-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span></font></p><p><br></p>","lesson":"am78g","interaction":"sff0i"},"kq8c1":{"id":"kq8c1","name":"الجزء ٢","content":"<p style=\\"text-align: center; direction: rtl;\\"><font size=\\"4\\">الجزء&nbsp;هنا&nbsp;فيه تفاعل يقيّم الدارس عكس الجزء اللي فات اللي نقل&nbsp;الدارس مباشرة للجزء اللي بعده.</font></p><p></p><p style=\\"text-align: center; direction: rtl;\\"><pstyle=\\"text-align:center;\\"><font size=\\"4\\">التفاعل الموجود هو عبارة عن سحب الإجابة للإختيار الصحيح.</font></pstyle=\\"text-align:center;\\"></p><p style=\\"text-align: center; direction: rtl;\\" class=\\"\\"><pstyle=\\"text-align:center;\\"><font size=\\"4\\">الدرس هيتطور بشكل مختلف وفقاً للإجابة.</font></pstyle=\\"text-align:center;\\"></p><p></p><p style=\\"text-align: center; direction: rtl;\\"><pstyle=\\"text-align:center;\\"><font size=\\"4\\">الإختيار هنا يؤدي لتخصيص التجربة التعليمية&nbsp;وفقاً لمعرفة&nbsp;الدارس وفهمه للمادة.</font></pstyle=\\"text-align:center;\\"></p><p></p><p style=\\"text-align: center;\\"><pstyle=\\"text-align:center;\\"><br></pstyle=\\"text-align:center;\\"></p><p></p><p style=\\"text-align: center; \\" class=\\"\\"><font size=\\"7\\">إختر صندوق<span id=\\"sceditor-end-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span><span id=\\"sceditor-start-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span></font></p>","lesson":"am78g","interaction":"0mt87"},"9aq44":{"id":"9aq44","name":"الجزء ٣","content":"<div style=\\"text-align: center;\\"><font size=\\"5\\">إجابة صحيحة<span id=\\"sceditor-end-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span><span id=\\"sceditor-start-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span></font></div><p></p><pstyle=\\"text-align:center;\\"><fontsize=\\"5\\"><spanid=\\"sceditor-end-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"><spanid=\\"sceditor-start-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"></spanid=\\"sceditor-start-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"></spanid=\\"sceditor-end-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"></fontsize=\\"5\\"></pstyle=\\"text-align:center;\\">","lesson":"am78g","interaction":"9p36b"},"d2ing":{"id":"d2ing","name":"الإجابة خطأ","content":"<div style=\\"text-align: center;\\"><br></div><p style=\\"text-align: center; direction: rtl;\\"><span style=\\"font-size: large;\\">إخترت الصندوق الخطأ.</span></p><p style=\\"text-align: center; direction: rtl;\\"><span style=\\"font-size: large;\\">عليك مشاهدة هنا&nbsp;فيديو قصير عن حملة لفصل المخلفات العضوية وغير العضوية.<span id=\\"sceditor-end-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span><span id=\\"sceditor-start-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span></span></p><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><p></p><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><div style=\\"text-align: center;\\"><br></div><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><div style=\\"text-align: center;\\"><iframe width=\\"560\\" height=\\"315\\" src=\\"http://www.youtube.com/embed/YknKtGIhFCo?wmode=opaque\\" data-youtube-id=\\"YknKtGIhFCo\\" frameborder=\\"0\\" allowfullscreen=\\"\\"></iframe><br></div><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><p></p><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><div style=\\"text-align: center;\\"><br></div><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><p></p><pstyle=\\"text-align:center;\\"><fontcolor=\\"#cc3366\\"><pstyle=\\"text-align:center;\\"><pstyle=\\"text-align:center;\\"><fontcolor=\\"#33cc66\\"><pstyle=\\"text-align:center;\\"><spanid=\\"sceditor-start-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"><spanid=\\"sceditor-end-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"><pstyle=\\"text-align:center;\\"><iframewidth=\\"560\\"height=\\"315\\"src=\\"http: www.youtube.com=\\"\\" embed=\\"\\" yknktgihfco?wmode=\\"opaque&quot;data-youtube-id=&quot;YknKtGIhFCo&quot;frameborder=&quot;0&quot;allowfullscreen=&quot;&quot;\\"></iframewidth=\\"560\\"height=\\"315\\"src=\\"http:></pstyle=\\"text-align:center;\\"></spanid=\\"sceditor-end-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"></spanid=\\"sceditor-start-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"></pstyle=\\"text-align:center;\\"></fontcolor=\\"#33cc66\\"></pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"></fontcolor=\\"#cc3366\\"></pstyle=\\"text-align:center;\\">","lesson":"am78g","interaction":"nbqpg"},"fpcnf":{"id":"fpcnf","name":"النهاية","content":"<div style=\\"text-align: center;\\"><pstyle=\\"text-align:center;\\"><fontsize=\\"7\\"><br></fontsize=\\"7\\"></pstyle=\\"text-align:center;\\"></div><div style=\\"text-align: center;\\"><pstyle=\\"text-align:center;\\"><fontsize=\\"7\\"><br></fontsize=\\"7\\"></pstyle=\\"text-align:center;\\"></div><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><p style=\\"text-align: center; direction: rtl;\\"><font size=\\"7\\">نهاية الدرس</font></p><p style=\\"text-align: center; direction: rtl;\\"><span style=\\"font-size: medium;\\"><br></span></p><p style=\\"text-align: center; direction: rtl;\\"><span style=\\"font-size: medium;\\">تقدر&nbsp;تعدل الدرس زي ما تحب، تعديلاتك&nbsp;مش هيشوفها حد إلا على جهازك.</span></p><p style=\\"text-align: center; direction: rtl;\\"><span style=\\"font-size: medium;\\"><br></span></p><p style=\\"text-align: center; direction: rtl;\\"><span style=\\"font-size: medium;\\">لو عايز تبدأ درس جديد، إضغط على \\"لوحة دروسي\\"<span id=\\"sceditor-end-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span><span id=\\"sceditor-start-marker\\" class=\\"sceditor-selection sceditor-ignore\\" style=\\"line-height: 0; display: none;\\"> </span>.</span><br></p><pstyle=\\"text-align:center;\\"></pstyle=\\"text-align:center;\\"><p></p><pstyle=\\"text-align:center;\\"><fontsize=\\"7\\"><pstyle=\\"text-align:center;\\"><fontsize=\\"3\\"><spanid=\\"sceditor-end-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"><spanid=\\"sceditor-start-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"><pstyle=\\"text-align:center;\\"><fontsize=\\"5\\"><pstyle=\\"text-align:center;\\"><fontsize=\\"5\\"><pstyle=\\"text-align:center;\\"><fontsize=\\"5\\"><pstyle=\\"text-align:center;\\"><fontsize=\\"5\\"><ahref=\\"http: 0.0.0.0:3000=\\"\\" #=\\"\\" dashboard\\"=\\"\\"><fontcolor=\\"#66cc33\\"></fontcolor=\\"#66cc33\\"></ahref=\\"http:></fontsize=\\"5\\"></pstyle=\\"text-align:center;\\"></fontsize=\\"5\\"></pstyle=\\"text-align:center;\\"></fontsize=\\"5\\"></pstyle=\\"text-align:center;\\"></fontsize=\\"5\\"></pstyle=\\"text-align:center;\\"></spanid=\\"sceditor-start-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"></spanid=\\"sceditor-end-marker\\"class=\\"sceditor-selectionsceditor-ignore\\"style=\\"line-height:0;display:none;\\"></fontsize=\\"3\\"></pstyle=\\"text-align:center;\\"></fontsize=\\"7\\"></pstyle=\\"text-align:center;\\">","lesson":"am78g","interaction":null}}},"App.Interaction":{"records":{"nbqpg":{"id":"nbqpg","name":"InteractionforBlueBinScene","type":"أكمل","scene":"d2ing","nextScene":"kq8c1","items":[],"targets":[]},"0mt87":{"id":"0mt87","name":"InteractionforScene2","type":"سحب","scene":"kq8c1","nextScene":"kq8c1","items":["mrndc"],"targets":["umdli","1p9gp"]},"9p36b":{"id":"9p36b","name":"InteractionforScene3","type":"إختيار","scene":"9aq44","nextScene":"9aq44","items":[],"targets":["b35j7","hm37p","2a7d4","jvboa"]},"sff0i":{"id":"sff0i","name":"Interaction for Scene1","type":"أكمل","scene":"rrgc8","nextScene":"kq8c1","items":[],"targets":[]}}},"App.Target":{"records":{"umdli":{"id":"umdli","name":"عضوي","content":null,"color":"rgb(94,58,84)","image":"/images/green-trash-closed.png","hover":"/images/green-trash-open.png","value":null,"interaction":"0mt87","nextScene":"9aq44"},"1p9gp":{"id":"1p9gp","name":"غير عضوي","content":null,"color":"rgb(167,121,84)","image":"/images/blue-trash-closed.png","hover":"/images/blue-trash-open.png","value":null,"interaction":"0mt87","nextScene":"d2ing"},"b35j7":{"id":"b35j7","name":"ماذا لو إخترت الصندوق الأزرق","content":null,"color":"rgb(73,139,136)","image":"/images/green-trash-closed.png","hover":"/images/green-trash-open.png","value":null,"interaction":"9p36b","nextScene":"d2ing"},"hm37p":{"id":"hm37p","name":"إرجع للجزء السابق","content":null,"color":"rgb(176,115,53)","image":"/images/green-trash-closed.png","hover":"/images/green-trash-open.png","value":null,"interaction":"9p36b","nextScene":"kq8c1"},"2a7d4":{"id":"2a7d4","name":"إرجع لأول جزء","content":null,"color":"rgb(104,113,137)","image":"/images/green-trash-closed.png","hover":"/images/green-trash-open.png","value":null,"interaction":"9p36b","nextScene":"rrgc8"},"jvboa":{"id":"jvboa","name":"نهاية الدرس","content":null,"color":"rgb(100,157,81)","image":"/images/green-trash-closed.png","hover":"/images/green-trash-open.png","value":null,"interaction":"9p36b","nextScene":"fpcnf"}}},"App.Item":{"records":{"mrndc":{"id":"mrndc","name":"بقايا الفراخ","image":"/images/composable/poultry.jpg","value":"umdli","interaction":"0mt87"}}}}';
        window.location.reload();
    }

    if (!localStorage['DS.LSAdapter']) {
        alert('شكلك كدة أول مرة تفتح السايت ده، هنيعملك درس مخصوص عشان تجرب.');
        loadExample();
    } else {
      ...
      window.onbeforeunload = (function () {
        if(!localStorage.getItem('feedback'))
            return "ياريت طالنا رأيك أبل متمشي، دوس على رأيك فالنفجشن";
      });

        this.get('controller.store').find('lesson').then(function (lessons) {
            if(lessons.get('length')===0) {
                if(confirm("إنت مسحت كل الدروس، تحب نعملك الدرس التجريبي تاني؟")) {
                    loadExample();
                }
            }
        });
